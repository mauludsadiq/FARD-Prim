...
104 tests across 11 suites, all passing.
...
- Boxed arithmetic still requires liborgntr_rt.a for fard_add_boxed_out
...
## Roadmap
   ...
   done   boxed arithmetic — FardVal layout, runtime ABI
   done   MH_EXECUTE — direct executable emission, ld removed
   next   mul_boxed proof
   then   OCIR type enforcement downstream
